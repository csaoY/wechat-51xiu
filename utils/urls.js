...
module.exports = {
    ...
    index: BASE_URL+"v1/indexProgram" ,

    newFix: BASE_URL +"v1/activityProgram",
    queryColor: BASE_URL+'v1/queryColor',
    queryProgramme: BASE_URL +'v1/queryProgramme',
    getrepairPlan:BASE_URL+"v1/getrepairPlan",
};